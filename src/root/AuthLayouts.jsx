    ...
    return (
        ...
        <section className="px-6 dark:bg-gray-100 dark:text-gray-800   ">
            ...
            <div className=" w-11/12 grid gap-6 mx-auto  lg:grid-cols-2 xl:grid-cols-5 h-screen">
                {/* text */}
                <div className="w-full px-6 py-16 rounded-md sm:px-12 md:px-16 xl:col-span-2 dark:bg-gray-50 h-full flex-1">
                    <Outlet></Outlet>
                </div>

                <img src="https://i.ibb.co.com/JWr7BQjk/auth-Image.png" alt="" className="object-cover w-full h-screen rounded-md xl:col-span-3 dark:bg-[#03373D]" />
