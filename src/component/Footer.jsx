...
const Footer = () => {
    ...
    return (
        <footer className="footer footer-horizontal footer-center bg-[#0B0B0B] text-base-content rounded-lg my-4 p-10 text-center">
            <aside>
                {/*  <svg
                    width="50"
                    height="50"
            ...
            <nav>
                <div className="grid grid-flow-col text-[#DADADA] gap-4">
                    ...
                    <Link to="https://www.youtube.com/watch?v=uIN16-nOWwo">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                            height="24"
